#include "Openchain3DoF_DynCtrl.hpp"
#include "OC3_Sim_Model.hpp"
#include <Utils/utilities.hpp>
#include <RBDL_Sim_Configuration.h>

Openchain3DoF_DynCtrl::Openchain3DoF_DynCtrl():DynControlTester(),
                                               jpos(NUM_ACT_JOINT),
                                               jvel(NUM_ACT_JOINT),
...
Openchain3DoF_DynCtrl::~Openchain3DoF_DynCtrl(){}

void Openchain3DoF_DynCtrl::Initialization(){
  m_jpos_ini.setZero();
  m_jvel_ini.setZero();
...
void Openchain3DoF_DynCtrl::_UpdateLinePosition(){
  plot_sys_->GetStEndPt_Link(st_x_, st_y_, end_x_, end_y_);
}

void Openchain3DoF_DynCtrl::_UpdateCommand(){ // m_cmd update
  double time;
...
void Openchain3DoF_DynCtrl::_MakeOneStepUpdate(){ // model advance one step
...
void Openchain3DoF_DynCtrl::_ExtraProcess(){}
void Openchain3DoF_DynCtrl::_UpdateExtraData(){}

void Openchain3DoF_DynCtrl::_DataPrint(){
  // bool b_plot = true;
  bool b_plot = false;

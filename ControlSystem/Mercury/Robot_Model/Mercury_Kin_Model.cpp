...
void Mercury_Kin_Model::_UpdateCentroidFrame(const sejong::Vector & q, const sejong::Vector & qdot){
  double mass;
...
void Mercury_Kin_Model::getCoMPos(const sejong::Vector & q, sejong::Vect3 & CoM_pos, bool update)const {
  Vector3d zero_vector = Vector3d::Zero();
...
void Mercury_Kin_Model::getCoMVel(const sejong::Vector & q, const sejong::Vector & qdot, sejong::Vect3 & CoM_vel) const {
...
void Mercury_Kin_Model::getPosition(const Vector & q, int link_id, Vect3 & pos){
  Vector3d zero;
  // zero << 0.0, 0.0, 0.0;
...
void Mercury_Kin_Model::getOrientation(const Vector & q, int link_id, sejong::Quaternion & ori){
  Matrix3d R;
...
void Mercury_Kin_Model::getVelocity(const Vector & q, const Vector &qdot,
...
void Mercury_Kin_Model::getAngVel(const Vector & q, const Vector & qdot,
...
void Mercury_Kin_Model::getJacobian(const Vector & q, int link_id, Matrix &J){

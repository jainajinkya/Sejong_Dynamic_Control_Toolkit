#ifndef LIPM_ACTOR_CRITIC_FEATURE_RBF
#define LIPM_ACTOR_CRITIC_FEATURE_RBF
...
// Action: xp, v_apex
class LIPM_ActorCritic_RBF: public LIPM_ActorCritic_Learner{
 public:
  LIPM_ActorCritic_RBF();
  virtual ~LIPM_ActorCritic_RBF();
 ...
 protected:
  ...
  void _SingleTrialTest(const double * ini_state);

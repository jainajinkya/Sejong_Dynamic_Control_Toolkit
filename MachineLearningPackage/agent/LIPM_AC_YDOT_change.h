#ifndef LIPM_ACTOR_CRITIC_YDOT_CHANGE
#define LIPM_ACTOR_CRITIC_YDOT_CHANGE
...
// Action: xp, v_apex
class LIPM_AC_YDOT_change: public LIPM_ActorCritic_Learner{
 public:
  LIPM_AC_YDOT_change();
  virtual ~LIPM_AC_YDOT_change();

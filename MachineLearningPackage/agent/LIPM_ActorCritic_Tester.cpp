#include "LIPM_ActorCritic_Tester.h"
...
LIPM_ActorCritic_Tester::LIPM_ActorCritic_Tester():
  LIPM_Tester()
{
...
void LIPM_ActorCritic_Tester::Build_Test_Information(LIPM_3D* lipm, Agent* agent){
  LIPM_ActorCritic_Learner * _agent = dynamic_cast<LIPM_ActorCritic_Learner*>(agent);
  // Each Initial Time

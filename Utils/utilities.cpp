...
namespace sejong{
  ...
  //           Save Data
  ////////////////////////////////////////////////////
  void saveVector(const sejong::Vector & _vec, string _name, bool b_param){
    string file_name;
  ...
  void saveQuaternion(const sejong::Quaternion & qq, std::string _name, bool b_param){
    string file_name;
    cleaning_file(_name, file_name, b_param);
    std::ofstream savefile(file_name.c_str(), ios::app);
    savefile<<qq.w()<< "\t";
  ...
  void saveVectorSequence(const std::vector<sejong::Vector> & seq, string _name, bool b_param){
    string file_name;
    cleaning_file(_name, file_name, b_param);
